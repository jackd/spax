...
class PolyTest(jtu.JaxTestCase):
    ...
    def test_chebyshev1(self):
        ...
        a = jax.random.normal(k0, shape=(n, n), dtype=dtype)
        v = jax.random.normal(k1, shape=(n,), dtype=dtype)
        c0 = poly.chebyshev1(a, v, 0)
        c1 = poly.chebyshev1(a, v, 1)
        c2 = poly.chebyshev1(a, v, 2)
        c3 = poly.chebyshev1(a, v, 3)
        self.assertAllClose(c0, v)
        self.assertAllClose(c1, a @ v)
        self.assertAllClose(c2, 2 * a @ c1 - c0)
        self.assertAllClose(c3, 2 * a @ c2 - c1)
